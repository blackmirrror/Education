...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class Okhttp3LoggingLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>okhttp3.logging.interceptor</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class RetrofitConverterLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>retrofit.converter</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getRxjava3() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("retrofit.converter.rxjava3");
        }
    ...
    public static class RxLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>android</b> with <b>io.reactivex.rxjava3:rxandroid</b> coordinates and
         * with version reference <b>rx.android</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        /**
         * Dependency provider for <b>java</b> with <b>io.reactivex.rxjava3:rxjava</b> coordinates and
         * with version reference <b>rx.java</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Group of versions at <b>versions.okhttp3</b>
         */
        ...
        /**
         * Group of versions at <b>versions.rx</b>
         */
    ...
    public static class KoinVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>koin.android</b> with value <b>3.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class Okhttp3VersionAccessors extends VersionFactory  {
        ...
        /**
         * Group of versions at <b>versions.okhttp3.logging</b>
         */
    ...
    public static class Okhttp3LoggingVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>okhttp3.logging.interceptor</b> with value <b>4.11.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class RetrofitVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>retrofit.converter</b> with value <b>2.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getConverter() { return getVersion("retrofit.converter"); }
    ...
    public static class RxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>rx.android</b> with value <b>3.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroid() { return getVersion("rx.android"); }

        /**
         * Version alias <b>rx.java</b> with value <b>3.1.9</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJava() { return getVersion("rx.java"); }
